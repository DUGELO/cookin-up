<script lang="ts">
import { itensLista1EstaoEmItensLista2 } from '@/operacoes/listas';
...
export default {
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas.filter((receita) => {
        ...
        const possoFazerReceita = itensLista1EstaoEmItensLista2(receita.ingredientes, this.ingredientes);
