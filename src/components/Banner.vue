<template>
    ...
    <img src="cookin-up\src\assets\images\foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de vidro na mão. Ela está sorrindo e está apoiando um celular entre seu rosto e seu ombro" class="foto-banner">
  </header>
</template>
